...
Object.defineProperty(tenonUtils_cjs, '__esModule', { value: true });
...
function getShadowValue(value) {
    ...
    const shadowItems = transformValue$1(value);
...
export { Base, BaseTransition, Button, Comment$1 as Comment, EffectScope, Fragment, Image, Input, KeepAlive, MatchType, Page, ReactiveEffect, RelationType, RootViewComponent, RuleKeyMap, Static, Suspense, Switch, Teleport, Text$1 as Text, TextArea, View, appContext, callWithAsyncErrorHandling, callWithErrorHandling, camelize$1 as camelize, capitalize, cloneVNode, collectStyle, compatUtils, component, computed, container, createApp, createBlock, createCommentVNode, createElementBlock, createBaseVNode as createElementVNode, createHydrationRenderer, createRenderer, createRootContainer, createSlots, createStaticVNode, createTextVNode, createVNode, customRef, index as default, defineAsyncComponent, defineComponent, defineEmits, defineExpose, defineProps, devtools, directive, effect, effectScope, getClassStyle, getComponent, getCurrentInstance, getCurrentScope, getTransitionRawChildren, guardReactiveProps, h, handleError, initCustomFormatter, inject, isMemoSame, isProxy, isReactive, isReadonly, isRef, isRuntimeOnly, isVNode, markRaw, mergeDefaults, mergeProps, mixin, nextTick, normalizeClass, normalizeProps, normalizeStyle, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, openBlock, popScopeId, provide, proxyRefs, pushScopeId, queuePostFlushCb, reactive, readonly, ref, register, registerRuntimeCompiler, render, renderApp, renderCustomSlot, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveFilter, resolveTransitionHooks, setBlockTracking, setDevtoolsHook, setTransitionHooks, shallowReactive, shallowReadonly, shallowRef, ssrContextKey, ssrUtils, stop, toDisplayString, toHandlerKey, toHandlers, toRaw, toRef, toRefs, transformVNodeArgs, triggerRef, unref, use, useAttrs, useSSRContext, useSlots, useTransitionState, vAnimation, vModelSwitch, vModelText, vShow, version, warn, watch, watchEffect, watchPostEffect, watchSyncEffect, withAsyncContext, withCtx, withDefaults, withDirectives, withMemo, withScopeId };
//# sourceMappingURL=tenon-vue.es.js.map
